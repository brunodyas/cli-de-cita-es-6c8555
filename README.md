# Cli De Cita Es 6C8555

Aplicação backend `cli-de-cita-es-6c8555` construída com foco em boas práticas de engenharia.

## Visão Geral
- Nome da aplicação: `cli-de-cita-es-6c8555`
